...
<div class="ficha-wrap">
  <div class="ficha-card">
    ...
    <div class="ficha-left">
      ...
      <!-- CÓDIGO (único input editable) -->
      <div class="field">
        <label for="codigo">Código</label>
        <input id="codigo" name="codigo" type="text" class="input" placeholder="Ej: FIC-00123" />
      </div>

      <!-- MUNICIPIO (abre panel) -->
      <div class="field">
      ...
      <!-- JORNADA (dropdown fijo) -->
      <div class="field">
        <label for="jornada">Jornada</label>
        <select id="jornada" name="jornada" class="input">
      ...
      <div class="field">
        ...
        <!-- duración en meses (la trae el programa) -->
      ...
      <div class="row">
        <div class="field">
          ...
          <input id="fecha_inicio" name="fecha_inicio" type="date" class="input" />
        </div>
